...
# MEMO: -m options https://linux.die.net/man/1/ld
...
# REF: https://linux.die.net/man/1/ld#:~:text=---,section,--start%3Dsectionname%3Dorg
initcode: initcode.S
...
# MEMO: main.cはkernel, bootblockがbootloader
